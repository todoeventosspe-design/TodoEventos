...
Video de 1:52 para el formulario de la competencia de startups de la
Universidad de Lima ("Graba un video mostrándonos el problema y solución de tu
proyecto, máximo 2 minutos"). 1920×1080, 30 fps, **sin audio** — todo el
mensaje va en pantalla, así se entiende aunque el jurado lo vea sin sonido.
...
| Tiempo | Bloque |
|---|---|
| 0:00–0:07 | Apertura: "Organizar un evento en Lima hoy se hace así" |
| 0:07–0:42 | **El caos del cliente.** Valeria busca DJ, catering y fotógrafo por DM. Tres conversaciones ficticias con zoom sobre el "Visto hace 2 días", el "te paso la info" que nunca llega y el precio que cambia. Cierra con el marcador: 9 proveedores escritos, 3 respuestas, 0 precios en firme. |
| 0:42–1:12 | **El caos del proveedor.** La bandeja de Marco con 14 mensajes sin responder, y su agenda real: una libreta con dos eventos el mismo sábado. |
| 1:12–1:20 | La brecha: "Ella busca. Él existe. No se cruzan." |
| 1:20–1:44 | **La solución**, con capturas reales del producto: catálogo con precios, agenda sin cruces, cotizador con total y PDF, reportes. |
| 1:44–1:52 | Cierre de marca. |
...
node render.mjs                 # ~3.5 min, 3360 JPG
node vistazo.mjs 16 27 60 93    # o solo estos segundos, para revisar

# 3. armar el MP4
ffmpeg -framerate 30 -i fotogramas/f%05d.jpg -c:v libx264 -preset slow \
  -crf 20 -pix_fmt yuv420p -movflags +faststart salida.mp4
```
...
- **Cambiar la duración de un bloque:** la constante `B` y `DURACION`. Ojo con
  el límite de 2 minutos del formulario.
