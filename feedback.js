...
(function(){
  ...
  var css = ''
    ...
    + 'writing-mode:vertical-rl;text-orientation:mixed;letter-spacing:.06em;box-shadow:-4px 8px 24px rgba(249,115,22,.48);transition:padding .15s,background .15s;}'
    + '#fbk-tab:hover{padding-right:13px;background:#C2410C;}'
